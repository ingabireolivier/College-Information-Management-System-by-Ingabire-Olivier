...
<td height="423" colspan="5" align="center" valign="top" bgcolor="#EDEDED">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="1">
            ...
            <td>
                ...
                ?>
                    <table width="100%" border="1" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; width:99.95%; border-color:#009999;">
                      ...
                      <tr>
                        <td width="28%" height="30" style="padding-left:10px;">Student ID | Username</td>
		      ...
		      <tr>
                        <td width="28%" height="30" style="padding-left:10px;">Status</td>
            ...
            <td>
                ...
                ?>
                    <table width="100%" border="1" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; width:99.95%; border-color:#009999;">
                      ...
                      <tr>
                        <td width="28%" height="30" style="padding-left:10px;">Faculty</td>
          ...
          <tr><td align="center" height="40">
			<? if ($_SESSION['utype'] == "Administrator"){?>
          <a href="student.php"><strong>Create New</strong></a>&nbsp;|&nbsp;<a href="editstudent.php?id=<?=$id?>"><strong>Edit</strong></a>&nbsp;|&nbsp;<a href="deletestudent.php?id=<?=$id?>" onClick="return confirm('Sure! You want to delete?');"><strong>Delete</strong></a>&nbsp;|&nbsp;<? }?><a href="viewallstudent.php"><strong>View All Registered Students</strong></a></td>
          </tr>
      </table>
