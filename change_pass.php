...
if (isset($_POST['Submit'])){
	...
	if ($curpass == "" || $newpass == "" || $retypepass == ""){
		...
		if ($_SESSION['utype'] == "Administrator"){
			$sql = "select pass from admin where id=$id and pass='$curpass'";
		}
...
if ($err == ""){
	if ($_SESSION['utype'] == "Administrator"){
		$sql = "update admin set pass='$newpass' where id=$id";
	}
	elseif ($_SESSION['utype'] == "student"){
...
<form name="personal" method="post" action="change_pass.php">
