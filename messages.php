...
<td height="423" colspan="5" align="left" valign="top" bgcolor="#EDEDED">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="1">
          <tr>
            <td height="20" bgcolor="#8C8989"><span class="style1"><strong> &nbsp;&nbsp;Messages</strong></span></td>
          </tr>
      </table>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="20" style="padding:10px;"><p align="left">&nbsp;&nbsp;&nbsp;&nbsp;                                                     
              <blockquote>
                <ul>
                  <li><a href="stdmsg.php" title="MESSAGES FROM Student">STUDENTS MESSAGES </a></li>
				   <li><a href="stfmsg.php" title="New Staff">STAFF MESSAGES</a></li>
