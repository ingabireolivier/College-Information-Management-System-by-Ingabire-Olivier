...
if ($err != ""){
    ...
    $stdid = $_POST['stdid'];
    $query = mysql_query("select * from student where stdid='$stdid' and email='$email'");
	...
	if ($numRows != 0){
		...
		$mail->Body = 'Hi ' . $stdid . ', your password is ' . $pass;
		$mail->Send();
	}
	else{
		$err = "Wrong Student ID or E-Mail";
	}
...
<form name="personal" method="post" action="forgotstd.php">
...
<td height="423" colspan="5" align="left" valign="top" bgcolor="#EDEDED">
        ...
        <div align="left" style=" padding:10px; background-color:#6699FF; border: solid 1px #0000FF; border-width:medium; border-color:#666666; color:#FFFFFF;">Your Password send to <?=$email?></div>
		<? }?>
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="19%" height="30" style="padding:4px;">Student ID</td>
            <td width="81%" height="30" style="padding:4px;"><input name="stdid" type="text" id="stdid" size="30"></td>
          </tr>
          <tr>
