...
<html>
<head>
<title>TCTWBIMS | VIEW STAFF</title>
...
<td height="423" colspan="5" align="center" valign="top" bgcolor="#EDEDED">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="1">
          <tr>
            <td height="20" bgcolor="#8C8989"><span class="style1"><strong>Saff DETAILS</strong></span></td>
          </tr>
      </table>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="1">
            ...
            <td>
                ...
                ?>
                    <table width="100%" border="1" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; width:99.95%; border-color:#009999;">
                      <tr>
                        <td height="30" colspan="2" style="padding-left:10px; font-weight:bold; background-color:#9AB9DC;">Staff Details</td>
                      </tr>
					  <tr>
                      ...
                      <tr>
                        <td width="28%" height="30" style="padding-left:10px;">Staff ID</td>
                        <td width="72%" height="30" style="padding:4px; font-weight:bold; color:#CC0033;"><?=$res['stfid']?></td>
                      </tr>
                      ...
                      <? }?>
                      <tr>
                        <td width="28%" height="30" style="padding-left:10px;">Staff Name</td>
                        <td width="72%" height="30" style="padding:4px;"><?=$res['stfname']?></td>
                      </tr>
                      <tr>
          ...
          <tr>
            <td>
                ...
                ?>
                    <table width="100%" border="1" cellpadding="0" cellspacing="0" align="left" style="border-collapse:collapse; width:99.95%; border-color:#009999;">
                      <tr>
                        <td height="30" colspan="2" style="padding-left:10px; font-weight:bold; background-color:#9AB9DC;">College Staff Details</td>
                      </tr>
                      <tr>
                        <td width="28%" height="30" style="padding-left:10px;">Field</td>
                        <td width="72%" height="30" style="padding:4px;"><?=$res['field']?></td>
                      </tr>
                      <tr>
                        <td width="28%" height="30" style="padding-left:10px;">Qualification</td>
                        <td width="72%" height="30" style="padding:4px;"><?=$res['qualif']?></td>
                      </tr>
					  <tr>
                        <td width="28%" height="30" style="padding-left:10px;">Academic Year</td>
                        <td width="72%" height="30" style="padding:4px;"><?=$res['acad']?></td>
                      </tr>
                      <tr>
                        <td width="28%" height="30" valign="top" style="padding-left:10px; padding-top:13px;">Working Days Per Week</td>
                        <td width="72%" height="30" style="padding:2px;"><?=$res['days']?></td>
                      </tr>
                      <tr>
                        <td width="28%" height="30" style="padding-left:10px;">Working Hours Per week</td>
                        <td width="72%" height="30" style="padding:4px;"><?=$res['hr']?></td>
                      </tr>
					  <tr>
          ...
          <tr><td align="center" height="40">
			<? if ($_SESSION['utype'] == "Administrator"){?>
          <a href="staff.php"><strong>Create New</strong></a>&nbsp;|&nbsp;<a href="editstaff.php?id=<?=$id?>"><strong>Edit</strong></a>&nbsp;|&nbsp;<a href="deletestaff.php?id=<?=$id?>" onClick="return confirm('Sure! You want to delete?');"><strong>Delete</strong></a>&nbsp;|&nbsp;<? }?><a href="viewallstaff2.php"><strong>View All Registered Staff</strong></a></td>
          </tr>
      </table>
