...
mysql_query("update staffmsg set hit=hit+1 where id=$id");
...
<td height="423" colspan="5" align="left" valign="top" bgcolor="#EDEDED">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="1">
          <tr>
            <td height="20" bgcolor="#8C8989"><span class="style1"><strong>View messages from Staff</strong></span></td>
          </tr>
      </table>
          <?
		  $query = mysql_query("select * from staffmsg where id=$id");
        ...
        <table width="100%" border="1" cellpadding="0" cellspacing="0" style=" border-collapse:collapse; border-color:#009999">
          <tr>
            <td width="21%" height="20" align="left" valign="middle" style="padding:4px;">Staff ID</td>
            <td width="79%" align="left" valign="middle" style="padding:4px;"><?=$res['stfid']?></td>
          </tr>
          <tr>
            <td height="20" align="left" valign="middle" style="padding:4px;">Staff Name</td>
            <td align="left" valign="middle" style="padding:4px;"><?=$res['stfname']?></td>
          </tr>
          <tr>
            <td height="20" align="left" valign="middle" style="padding:4px;">E-Mail ID</td>
            <td align="left" valign="middle" style="padding:4px;"><a style="Text-Decoration:none" href="mailto: <? echo $res["email"] ?> "><? echo $res["email"] ?> </a>| Click to this email and Reply <? echo $res["stfname"] ?> |</td></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            &nbsp;&nbsp;<a href="stfmsgdelete.php?id=<?=$id?>" onClick="javascript:return confirm('Sure! Do you want to Delete?');">Delete</a>
            </td>
          </tr>
        </table>
      ...
      <? }
			...
			echo "<br><br><div align=center><font color=red><b>ERROR! MESSAGE MAY BE DELETED</b></font></div>";
		}
