...
<html>
<head>
<title>TCTWBIMS | STAFF HOME</title>
...
<td height="423" colspan="5" align="left" valign="top" bgcolor="#EDEDED">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="1">
          <tr>
            <td height="20" bgcolor="#8C8989"><span class="style1"><strong> &nbsp;&nbsp;Staff</strong></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
?></td>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="20" style="padding:10px;"><img src="images/staffarea.jpg" align="right"> <p align="left">&nbsp;&nbsp;&nbsp;&nbsp;                                                       Welcome to <strong>TCTWBIMS.&nbsp; </strong>As Staff you dont have all rights in this system.  You are only able to <strong>Search & View</strong> any student or staff but You are <strong>not able to edit, delete or add </strong> their information. </p>
         You are able to <strong>send message to admin</strong> and email to others. Use your password that you can change anytime and login as Staff. Enjoy</p></td>
          </tr>
