...
<td height="423" colspan="5" align="center" valign="top" bgcolor="#EDEDED">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="1">
          ...
          <tr><td align="center" height="40">
			<? if ($_SESSION['utype'] == "Administrator"){?>
          <a href="staff.php"><strong>Create New</strong></a>&nbsp;|&nbsp;<a href="editstaff.php?id=<?=$id?>"><strong>Edit</strong></a>&nbsp;|&nbsp;<a href="deletestaff.php?id=<?=$id?>" onClick="return confirm('Sure! You want to delete?');"><strong>Delete</strong></a>&nbsp;|&nbsp;<? }?><a href="viewallstaff.php"><strong>View All Registered Staff</strong></a></td>
          </tr>
      </table>
