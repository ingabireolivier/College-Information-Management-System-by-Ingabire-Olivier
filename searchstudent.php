...
<td height="423" colspan="5" align="left" valign="top" bgcolor="#EDEDED">
      ...
      <form name="search" method="post" action="searchstudent.php" style="margin-top:0px; margin-bottom:3px;">
    ...
    <?
        ...
        <? }
          ...
          <div align="center" style=" padding:10px; color:#000000; font-weight:bold; background-color:#FFCCFF; border: outset 2px #0000FF; border-width:medium; border-color:#003399;">NO RESULT FOUND!</div><br><br><br>   <a href="searchstudent.php">TRY AGAIN</a> ';
		}
